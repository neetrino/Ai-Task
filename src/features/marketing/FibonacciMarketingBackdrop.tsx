...
export function FibonacciMarketingBackdrop() {
  return (
    ...
    >
      ...
      <div className="fib-orb-drift fib-orb-drift-delay fib-orb-golden-a fib-size-glow-lg absolute rounded-full bg-amber-500/[0.14] blur-[100px]" />
      ...
      >
        <defs>
          <linearGradient id="fib-spiral-grad" x1="0%" x2="100%" y1="0%" y2="100%">
            <stop offset="0%" stopColor="rgb(251 191 36)" stopOpacity="0.52" />
